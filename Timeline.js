...
Timeline.append("g")
    ...
    .attr("y2",d => yScale(d.Y_position)*0.5)
    .attr("y1",yScale(300))
    .attr("stroke", "white")
    .attr("stroke-width", 3)
...
Timeline.append("g")
    ...
    d3.select(this).style("opacity",1).attr("stroke", "#ffa50a")
        timeline_tooltip.transition()
            .duration(200)
            .style("visibility","visible")

        d3.select(this)
        timeline_tooltip.html("<span style='color:black;'><h3>"+d.Year+"</h3><span style='color:black;'><h2>"+d.Event+"</h2><img src="+d.Media+" style='max-width:100%;height:auto; ></ahref></span><span style='color:black'><p>"+d.Description+"</p></span>" )                            
    ...
    .on("mouseout",function (event,d){
        d3.select(this).attr("stroke-width",3).attr("stroke", "#ffa50a")
