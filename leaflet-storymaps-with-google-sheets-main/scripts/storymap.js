  ...
  */
  ...
  function initMap(options, chapters) {
    ...
    for (i in chapters) {
      ...
      // PDF
      if (c['Media Link'] && c['Media Link'].indexOf('.pdf') > -1) {
        media = $('<iframe></iframe>', {
          src: c['Media Link'],
          width: '100%',
          height: '100%',
      ...
      // Texas History newspaper
      if (c['Media Link'] && c['Media Link'].indexOf('texashistory.unt.edu/') > -1) {
        media = $('<iframe></iframe>', {
          src: c['Media Link'],
          width: '100%',
          height: '100%',
      ...
      // Vimeo
      if (c['Media Link'] && c['Media Link'].indexOf('vimeo.com/') > -1) {
        media = $('<iframe></iframe>', {
          src: c['Media Link'],
          width: '100%',
          height: '100%',
